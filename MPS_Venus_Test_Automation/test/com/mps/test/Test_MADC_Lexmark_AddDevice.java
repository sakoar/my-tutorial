...
public class Test_MADC_Lexmark_AddDevice {
WebDriver driver;
...
Thread.sleep(4000);
register_device.productSelection();//Selecting product from drop down list by calling function
Thread.sleep(5000);
/*
...
logger.info("All Details Validated: Requests - MADC - Add Device - Data Only Completed successfully");
}
